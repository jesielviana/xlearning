...
public class AvatarServlet extends HttpServlet
{
   ...
   private static Logger logger = Logger.getLogger(AvatarServlet.class);
   @EJB
   ...
   private void getImagePath()
   {
      try
      {
         imagePath = parametroService.getParametroString(NumeroParametro.PATH_AVATAR_USUARIO);

      }
      catch (Exception e)
      {
         logger.info("Não existe parametro cadastrado para path de avatar.");
      }
